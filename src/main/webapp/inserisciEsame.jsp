...
<html>
    ...
    <body>
    	<form action="/Esame/insEsame" method="get" enctype="multipart/form-data"  height="50" valign="middle" border="2" bordercolor="blue" bordercolorlight="#00CCFF" bordercolordark="#000099">
    		<div class="form-group">
                ...
                <select class="form-control" id = "studente" name ="idStudente" required autofocus>
  			    ...
  			    <button type="submit">Inserisci Esame</button>
  			</div>
    		</div>
    	</form>
    </body>
